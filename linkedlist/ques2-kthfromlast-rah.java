...
public class TestPad {
	...
	public static void main(String args[]) {
		...
		System.out.println("Q2 - The x position from the end");
		System.out.println("Enter the index : ");
		int index = scanner.nextInt();

		test.findValueAtIndex(index);


	}
////////////////////////////////////////////////////////
//////////////////////////////////////////////////
	private void findValueAtIndex(int index) {
		...
		System.out.println("The value at " + index + " from end is " + temp.data);
